...
beowulf = Climb.create!(name: 'Beowulf', grade: 'WI4', approach: 'III', latitude: 51.32583, longitude: -115.24139, region: northghost, avi: blue, description: "Long climb up a drainage. The last pitch escapes the canyon and climbs up to the left. Definitely a favorite. 60m ropes are okay. Bolted except for last pitch.")
